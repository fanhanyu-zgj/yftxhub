...
//		"VariableName":"user",
//		"VariablesNamePlural":"users",
//		"PackageName":"user",
//	}
//
// -
// 两个词或者以上，用户命令传参，以 TopicComent 模型为例:
// - topic_comment
// - topic_comments
// - TopicComment
// - TopicComments
...
//		"VariableName":"topic_comment",
//		"VariablesNamePlural":"topic_comments",
...
// 最后一个选项可以选，如若传参，应传 map[string]string 类型 ，作为附加的变量搜索替换
